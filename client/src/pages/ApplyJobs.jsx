...
const ApplyJobs = () => {
    ...
    // Creating function to handle check already applied for a job
    ...
    return jobData ? (
        <>
            ...
            <div className='min-h-screen flex flex-col py-10 container px-4 xl:px-20 mx-auto'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-start'>
                        ...
                        <div className='w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5'>
                            ...
                            {jobs.filter(job => job._id !== jobData._id && job.companyId._id === jobData.companyId._id).filter(job => {
                                ...
                                // Return true if the user has not applied fot his job
